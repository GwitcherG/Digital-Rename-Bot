...
class Config(object):
    ...
    # other configs
    RKN_PIC = os.environ.get("RKN_PIC", "https://telegra.ph/file/eb80582fa42f9bd412085.jpg")
...
Tʜɪs Bᴏᴛ Wᴀs Cʀᴇᴀᴛᴇᴅ Bʏ : @Unlimited_Movie_Zone 💞</b>"""

    ABOUT_TXT = """<b>╭───────────⍟
├🤖 ᴍy ɴᴀᴍᴇ : {}
├🖥️ Dᴇᴠᴇʟᴏᴩᴇʀꜱ : <a href=https://t.me/GwitcherG>GwitcherG</a> 
├👨‍💻 Pʀᴏɢʀᴀᴍᴇʀ : <a href=https://github.com/GwitcherG>GwitcherG</a>
├📕 Lɪʙʀᴀʀy : <a href=https://github.com/pyrogram>Pyʀᴏɢʀᴀᴍ</a>
├✏️ Lᴀɴɢᴜᴀɢᴇ: <a href=https://www.python.org>Pyᴛʜᴏɴ 3</a>
├💾 Dᴀᴛᴀ Bᴀꜱᴇ: <a href=https://cloud.mongodb.com>Mᴏɴɢᴏ DB</a>
├📊 ᴠᴇʀsɪᴏɴ: <a href=https://github.com/GwitcherG/Digital-Rename-Bot>3.𝟶.𝟶</a></b>     
╰───────────────⍟ """
...
•⪼ 🥈𝘚𝘪𝘭𝘷𝘦𝘳    -     7𝘥𝘢𝘺𝘴 -    250
•⪼ 🥇𝘎𝘰𝘭𝘥     -    15𝘥𝘢𝘺𝘴 -   500
•⪼ 🏆𝘗𝘭𝘢𝘵𝘪𝘯𝘶𝘮  -    1𝘮𝘰𝘯𝘵𝘩 -   1000
•⪼ 💎𝘋𝘪𝘢𝘮𝘰𝘯𝘥  -    2𝘮𝘰𝘯𝘵𝘩 -   1500

- 𝘋𝘢𝘪𝘭𝘺 𝘜𝘱𝘭𝘰𝘢𝘥 𝘓𝘪𝘮𝘪𝘵 𝘜𝘯𝘭𝘪𝘮𝘪𝘵𝘦𝘥
- 𝘋𝘪𝘴𝘤𝘰𝘶𝘯𝘵 𝘈𝘭𝘭 𝘗𝘭𝘢𝘯 𝘙𝘴.10%
    """
    THUMBNAIL = """
...
◦ <code> -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @Unlimited_Movie_Zone" -metadata author="@Unlimited_Movie_Zone" -metadata:s:s title="Subtitled By :- @Unlimited_Movie_Zone" -metadata:s:a title="By :- @Unlimited_Movie_Zone" -metadata:s:v title="By:- @Unlimited_Movie_Zone" </code>

📥 Fᴏʀ Hᴇʟᴘ Cᴏɴᴛ. @Unlimited_Movie_Zone
"""
...
Exᴀᴍᴩʟᴇ:- `/set_suffix @Unlimited_Movie_Zone`
Exᴀᴍᴩʟᴇ:- `/set_prefix @Unlimited_Movie_Zone`
"""
    
    #⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️⚠️
#⚠️ Dᴏɴ'ᴛ Rᴇᴍᴏᴠᴇ Oᴜʀ Cʀᴇᴅɪᴛꜱ @Unlimited_Movie_Zone
    # ᴡʜᴏᴇᴠᴇʀ ɪs ᴅᴇᴘʟᴏʏɪɴɢ ᴛʜɪs ʀᴇᴘᴏ ɪs ᴡᴀʀɴᴇᴅ ⚠️ ᴅᴏ ɴᴏᴛ ʀᴇᴍᴏᴠᴇ ᴄʀᴇᴅɪᴛs ɢɪᴠᴇɴ ɪɴ ᴛʜɪs ʀᴇᴘᴏ #ғɪʀsᴛ ᴀɴᴅ ʟᴀsᴛ ᴡᴀʀɴɪɴɢ ⚠️
    DEV_TXT = """<b><u>Sᴩᴇᴄɪᴀʟ Tʜᴀɴᴋꜱ & Dᴇᴠᴇʟᴏᴩᴇʀꜱ</b></u>
    
» 𝗦𝗢𝗨𝗥𝗖𝗘 𝗖𝗢𝗗𝗘 : <a href=https://github.com/GwitcherG/Digital-Rename-Bot>Digital-Rename-Bot</a>

• ❣️ <a href=https://github.com/GwitcherG>GwitcherG</a>
