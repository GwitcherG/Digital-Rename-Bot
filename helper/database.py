...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            suffix=None,
            metadata_mode=False,
            metadata_code=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @Unlimited_Movie_Zone" -metadata author="@Unlimited_Movie_Zone" -metadata:s:s title="Subtitled By :- @Unlimited_Movie_Zone" -metadata:s:a title="By :- @Unlimited_Movie_Zone" -metadata:s:v title="By:- @Unlimited_Movie_Zone" """,
            expiry_time=None,
